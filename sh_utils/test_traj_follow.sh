gnome-terminal --window -e 'bash -c "sleep 1; roslaunch px4ctrl run_ctrl.launch; exec bash"' \
...
--tab -e 'bash -c "sleep 4; roslaunch planning perching.launch; exec bash"' \
--tab -e 'bash -c "sleep 5; roslaunch realflight_utils rc_remap.launch; exec bash"' \
--tab -e 'bash -c "sleep 6; roslaunch realflight_utils odom_remap_test.launch; exec bash"' \
