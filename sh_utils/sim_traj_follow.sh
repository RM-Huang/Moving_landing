...
gnome-terminal --window -e --tab -e 'bash -c "sleep 3; roslaunch px4ctrl run_ctrl.launch; exec bash"' \
...
--tab -e 'bash -c "sleep 4; rosrun simulation_utils cmdvel2rviz_keyboard; exec bash"' \
