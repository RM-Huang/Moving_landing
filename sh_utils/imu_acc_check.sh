gnome-terminal --window -e 'bash -c "roslaunch realflight_utils imu_analyse.launch; exec bash"' \
...
--tab -e 'bash -c "sleep 10; roslaunch px4ctrl run_ctrl.launch; exec bash"' \
